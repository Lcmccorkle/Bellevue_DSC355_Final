...
if submitted:
    with st.spinner("Predicting..."):
        ...
        try:
            ...
            # Re-apply category after reindex
            if 'Markdown_Group' in X_input.columns:
                X_input['Markdown_Group'] = X_input['Markdown_Group'].astype('category')
        ...
        try:
            ...
            st.info("Most likely cause: categorical column dtype mismatch or missing features.")
...
with st.expander("Model info"):
    ...
    - Some features use defaults when not provided
    """)
